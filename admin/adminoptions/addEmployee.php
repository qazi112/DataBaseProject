  ...
  <div class="form-group">
  	<div class="row">
  		<h4 id="errorMessage" class="text-danger">
            ...
            echo "<script> alert('Invalid Phone Number ! (Please Use Numbers Only)')</script>";
  					echo "Invalid Phone Number ! (Please Use Numbers Only).";
  				}else if($_GET['error']=="leaveDateinvalid"){
            echo "<script> alert('Invalid Department Leaving Date, It must must be greater than Or equal to 
            Join Date')</script>";
